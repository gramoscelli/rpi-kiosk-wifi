    ...
    <div _ngcontent-wmi-c48="" class="container-fluid">
        <div class="col-md-6 offset-md-3" style="margin-top: 9rem;">
           <div class="card">
               ...
               <div class="card-body">
                   <form action="/start/config.php" class="ng-untouched ng-pristine ng-invalid">
				...
				?>
                   ...
                   <div class="form-group">
                       ...
                       <input type="password" id="myInput" formcontrolname="password" name="pass" class="form-control ng-untouched ng-pristine ng-invalid" value="<?= $pass ?>">
                       <div>
